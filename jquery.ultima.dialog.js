					...
					var window = {
							...
							_: {
								...
								methods: {
									...
									getPadding: function(element) {
										...
										return {
											bottom: ( isNaN(parseInt(element.css('padding-bottom'), 10)) ? 0 : parseInt(element.css('padding-bottom'), 10) ),
											left: 	( isNaN(parseInt(element.css('padding-left'), 10)) ? 0 : parseInt(element.css('padding-left'), 10) ),
											right: 	( isNaN(parseInt(element.css('padding-right'), 10)) ? 0 : parseInt(element.css('padding-right'), 10) ),
											top: 	( isNaN(parseInt(element.css('padding-top'), 10)) ? 0 : parseInt(element.css('padding-top'), 10) )
										};
									},
						...
						// BEGIN: public methods
							...
							resize: function(disableScrolling) {
								...
								if (actualWidth > (jqWindow.width() - paddingH)) {

									actualOverflow = true;
									actualWidth = (jqWindow.width() - paddingH);
									...
									if (isFixed) {
										...
										this.dom.content.css('width', actualWidth - paddingH);
								...
								if (actualHeight > (jqWindow.height() - paddingV)) {

									actualOverflow = true;
									actualHeight = (jqWindow.height() - paddingV);
									...
									if (isFixed) {
										...
										this.dom.content.css('height', actualHeight - paddingV);
